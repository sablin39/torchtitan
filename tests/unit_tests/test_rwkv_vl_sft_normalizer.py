...
class TestRwkvVLSftNormalizer(unittest.TestCase):
    ...
    def test_toucan_oss_qwen3_tools_strip_duplicate_system_preamble(self):
        row = {
            "uuid": "toucan-oss-1",
            "subset_name": "fixture",
        ...
        self.assertEqual(
            normalized["messages"][3]["tool_calls"][0]["function"]["arguments"],
            {"query": "rwkv"},
        )
        self.assertEqual(normalized["messages"][4]["role"], "tool")
